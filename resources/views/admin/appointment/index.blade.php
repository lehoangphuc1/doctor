...
<div class=" containerrow justify-content">
    <div class="col-lg-12">
            ...
            <table class="table table-striped">
              <tbody>
                <tr>
                  ...
                  <td><input type="checkbox" name="time[]"  value="1.40am" @if(isset($times)) {{$times->contains('time','1.40pm')? 'checked' : ''}} @endif>1.40pm</td>
                </tr>
                 <tr>
                  <th scope="row">8</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                    ...
                    <input type="hidden" name="date" value="{{$appoinment->date}}"> <!--truyen hidden date vao-->
