...
class DoctorController extends Controller
{
    ...
    public function storeDoctor(Request $rq)
    {
       $this->validateStore($rq);
        $data = $rq->all();
        $name = (new User)->userAvatar($rq); //ham dc dinh nghia ben App/User
     ...
     */
    //validate khi save
    public function validateStore(Request $rq){
          $this->validate($rq,[
            'name' =>'required',
            ...
            'image' =>'required|mimes:jepg,jpg,png',
            'role_id' =>'required',
     ...
     public function validateUpdate(Request $request,$id){
        return  $this->validate($request,[
            'name'=>'required',
            'email'=>'required|unique:users,email,'.$id, //sửa theo id, ko bị exists
            'gender'=>'required',
            'education'=>'required',
            'address'=>'required',
            'department'=>'required',
